                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="bg-surface rounded-lg border shadow-lg  xxs:p-4 md:p-12 xxs:w-full md:w-full h-full relative ">
                            ...
                            <div className="grid grid-cols-1 gap-1 field mt-12">
                                ...
                                <input required className="border-2 border-gray-300 bg-surface px-5 pr-14 h-10 md:w-60 rounded-lg text-sm text-black focus:outline-none"
...
// <input required className="border-2 border-gray-300 bg-surface px-5 pr-14 h-10 w-60 rounded-lg text-sm text-black focus:outline-none"
