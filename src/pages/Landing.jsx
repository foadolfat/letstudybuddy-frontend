...
function Landing(){
    ...
    return(
        <div>
            ...
            <section class="w-full px-8 text-gray-700 bg-secondary">
                <div class="container flex flex-col flex-wrap items-center justify-between py-3 mx-auto md:flex-row max-w-7xl">
                    <div class="relative flex flex-col md:flex-row">
                        {/* <a href="#_" class="flex items-center mb-5 font-medium text-gray-900 lg:w-auto lg:items-center lg:justify-center md:mb-0">
                            <span class="mx-auto text-xl font-black leading-none text-gray-900 select-none">Study Buddy<span class="text-primary"></span></span>
                        </a> */}
                        <NavLink 
                        ...
                        <nav class="flex flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-primary-dark">
            ...
            <section class="px-2 pt-32 bg-primary-light md:px-0">
                <div class="container items-center max-w-6xl px-5 mx-auto space-y-6 text-center">
                    <h1 class="text-4xl font-extrabold tracking-tight text-left text-on-primary-light sm:text-5xl md:text-6xl md:text-center">
                        <span class="block">Find Your <span class="block mt-1 text-secondary lg:inline lg:mt-0">Study Buddy</span></span>
                    </h1>
                    <p class="w-full mx-auto text-base text-left text-on-primary-light md:max-w-md sm:text-lg lg:text-2xl md:text-center">
                    ...
                    <div class="relative flex flex-col justify-center md:flex-row md:space-x-4">
                        ...
                        {/* <a href="#_" class="flex items-center font-medium w-full px-6 py-3 mb-3 text-lg text-on-secondary bg-secondary rounded-md md:mb-0 hover:bg-secondary-dark hover: text-on-secondary-dark md:w-auto">
                            Sign Up Free
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ml-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <line x1="5" y1="12" x2="19" y2="12"></line>
                                <polyline points="12 5 19 12 12 19"></polyline>
                        ...
                        <a href="#_" class="flex items-center px-6 py-3 font-medium text-primary bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">
                            Learn More
                        </a>
                    </div>
                </div>
                <div class="container items-center max-w-4xl px-5 mx-auto mt-8 text-center">
                    <BOY  alt="Main Image"/>
            ...
            <section id={"how"} class="w-full bg-white pt-7 pb-7 md:pt-20 md:pb-24">
                <div class="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">

                    <div class="box-border relative w-full max-w-md px-4 mt-5 mb-4 -ml-5 text-center bg-no-repeat bg-contain border-solid md:ml-0 md:mt-0 md:max-w-none lg:mb-0 md:w-1/2 xl:pl-10">
                        <BEAR class="p-2 pl-6 pr-5 xl:pl-16 xl:pr-20 "/>
                       {/* <img src="https://cdn.devdojo.com/images/december2020/productivity.png" alt="Gist Image" class="p-2 pl-6 pr-5 xl:pl-16 xl:pr-20 "/> */}
                    </div>
                    ...
                    <div class="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
                        ...
                        <ul class="p-0 m-0 leading-6 border-0 border-gray-300">
                            <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                                <span class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-secondary-light rounded-full"><span class="text-sm font-bold">✓</span></span> Personalize your profile
                            </li>
                            <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                                <span class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-secondary-light rounded-full"><span class="text-sm font-bold">✓</span></span> Choose your class priority
                            </li>
                            <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                                <span class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-secondary-light rounded-full"><span class="text-sm font-bold">✓</span></span> Pick partners from our reccomendation list
                            </li>
                        </ul>
                    </div>
                ...
                <div class="box-border flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
                    ...
                    <div class="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
                        ...
                        <ul class="p-0 m-0 leading-6 border-0 border-gray-300">
                            <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                                <span class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-secondary-light rounded-full"><span class="text-sm font-bold">✓</span></span> Connect with your reccomended partners
                            </li>
                            <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                                <span class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-secondary-light rounded-full"><span class="text-sm font-bold">✓</span></span> Chat in groups or individually
                            </li>
                            <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                                <span class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-secondary-light rounded-full"><span class="text-sm font-bold">✓</span></span> Study away
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="box-border relative w-full max-w-md px-4 mt-10 mb-4 text-center bg-no-repeat bg-contain border-solid md:mt-0 md:max-w-none lg:mb-0 md:w-1/2">
                        <PIG class="pl-4 sm:pr-10 xl:pl-10 lg:pr-32"/>
                        {/* <img src="https://cdn.devdojo.com/images/december2020/settings.png" alt="Gist Image" class="pl-4 sm:pr-10 xl:pl-10 lg:pr-32"/> */}
                    </div>
                </div>
            </section>
            ...
            <section class="py-20 bg-primary-light">
                <div class="container max-w-6xl mx-auto">
                    <h2 class="text-4xl text-on-primary-light font-bold tracking-tight text-center">Our Features</h2>
                    <p class="mt-2 text-lg text-center text-on-primary-light">Check out our list of awesome features below.</p>
                    <div class="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
                        ...
                        <div class="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl">
                            <div class="p-3 text-white bg-secondary rounded-full">
                            ...
                            <h4 class="text-xl font-medium text-gray-700">Reccomendations</h4>
                            <p class="text-base text-center text-gray-500">Information you provide are used to tailor a list of students that would be suitable study partners for you.</p>
                        </div>
                        ...
                        <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                            ...
                            <h4 class="text-xl font-medium text-gray-700">Double Tap</h4>
                            <p class="text-base text-center text-gray-500">You'll only be notified that someone wants to study with you if you want to study with them as well.</p>
                        </div>
                        ...
                        <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                            ...
                            <h4 class="text-xl font-medium text-gray-700">Chat</h4>
                            <p class="text-base text-center text-gray-500">Easily chat with all your current study partners and switch between them as you change classes.</p>
                        </div>
                        ...
                        <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                            ...
                            <h4 class="text-xl font-medium text-gray-700">All In One Dashboard</h4>
                            <p class="text-base text-center text-gray-500">Dashboard that allows for chatting, viewing friendslist and finding new study partners all in one.</p>
                        </div>
                        ...
                        <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                            ...
                            <h4 class="text-xl font-medium text-gray-700">Customizable Profile</h4>
                            <p class="text-base text-center text-gray-500">Information provided in profile allows for better reccomendations. Your GPA, School, Degree, etc can all be customized. </p>
                        </div>
                        ...
                        <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl">
                            ...
                            <h4 class="text-xl font-medium text-gray-700">Free of charge!</h4>
                            <p class="text-base text-center text-gray-500">All these features are provided at no cost to you. As students ourselves, we want to help and we know money can be tight.</p>
                        </div>
                ...
                <div class="relative max-w-3xl px-10 text-center text-white auto lg:px-0">
                    <div class="flex flex-col w-full md:flex-row">
                        ...
                        <div class="relative top-0 right-0 h-64 mt-12 md:-mt-16 md:absolute md:h-96">
                            <CAT class="object-cover mt-3 mr-5 h-80 lg:h-96"/>
                            {/* <img src="https://cdn.devdojo.com/images/december2020/designs3d.png" alt="Single Gist" class="object-cover mt-3 mr-5 h-80 lg:h-96"/> */}
                        </div>
                    </div>
            ...
            <section class="py-20 bg-primary-light">
                <div class="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
                    <h2 class="text-3xl font-extrabold tracking-tight text-on-primary-light sm:text-4xl md:text-5xl xl:text-6xl">
                        A better way to learn
                    </h2>
                    <p class="max-w-md mx-auto mt-3 text-base text-on-primary-light sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                    ...
                    { !user &&
                        ...
                        <a href="#" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-primary bg-gray-100 border border-transparent rounded-md hover:bg-gray-200">Learn more</a>
                    </div>
                </div>
            </section>
