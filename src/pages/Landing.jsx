...
function Landing(){
    ...
    return(
        <div>
            ...
            <section class="py-20 --page-background" id="how" >
            ...
            <section className="w-full --page-background pt-7 pb-7 md:pt-20 md:pb-24">
            ...
            <section className="flex items-center justify-center py-10 text-white --page-background sm:py-16 md:py-24 lg:py-32">
